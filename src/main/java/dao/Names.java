...
public class Names {
	...
	private List<String> NY_indic = new ArrayList<String>(Arrays.asList(
			...
			"GDP: linked series (current LCU)", "Exports as a capacity to import (constant LCU)", 
	...
	private List<String> countries = new ArrayList<String>(Arrays.asList(
			"Albania", "Andorra", "Austria" , "Belgium" , "Bulgaria", "Bosnia and Herzegovina", 
			"Cyprus", "Czech Republic", "Germany" , "Denmark" , "Estonia" , "Finland" , "France", 
			"Faroe Islands", "Georgia" , "Gibraltar", "Greece" , "Greenland" , "Croatia", "Hungary",
			"Isle of Man" , "Ireland", "Iceland", "Italy", "Kosovo"));
	
	
	private List<String> yearSpan = new ArrayList<String>(Arrays.asList("5", "10", "20"));
	
	private List<String> years = new ArrayList<String>(Arrays.asList(
